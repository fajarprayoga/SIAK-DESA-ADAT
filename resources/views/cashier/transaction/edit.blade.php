                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="result form-control" type="text" disabled id="date"
                                            value="{{ date('d-m-Y', strtotime($transaction->created_at)) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control price" type="text" id="cost_of_goods"
                                            name="cost_of_goods" value="{{ $transaction->cost_of_goods }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control price" type="text" id="price_material"
                                            name="price_material" value="{{ $transaction->price_material }}" required>
                                    </div>
                                </div>
                                {{-- <div class="col-md-6">
                                <div class="mb-3">
                                ...
                                <input class="form-control" type="hidden" id="nomor" name="nomor"
                                    value="{{ $transaction->nomor }}" required>
                                {{-- </div>
                            </div> --}}
                                <div class="col-md-6">
                                    <div class="mb-3">
