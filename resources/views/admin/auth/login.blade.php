...
<head>
    ...
    <title>Desa Adat Punggang</title>
</head>
        ...
        <main class="authentication-content">
            <div class="container-fluid">
                <div class="authentication-card">
                    <div class="card shadow rounded-6 overflow-hidden">
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-4 p-sm-5">
                                    <h5 class="card-title">Desa Adat Punggang</h5>
                                    ...
                                    @endif
                                    <form class="form-body" action="{{ route('admin.auth.login') }}" method="POST"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <div class="ms-auto position-relative">
                                                    ...
                                                    <input type="text" class="form-control radius-30 ps-5"
                                                        id="inputEmailAddress" placeholder="Username" name="name">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <label for="inputChoosePassword" class="form-label">Masukan
                                                    Password</label>
                                                <div class="ms-auto position-relative">
                                                    <div
                                                        class="position-absolute top-50 translate-middle-y search-icon px-3">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit"
                                                        class="btn btn-primary radius-30">Masuk</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
