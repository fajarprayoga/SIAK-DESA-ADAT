...
<body>
    ...
    <div style="text-align : center">
        ...
        <h5>Buku Besar</h5>
        <h6><a target="_blank" href="{{ url('/') }}">Periode {{ date('d F Y', strtotime($ledger->register)) }} </a>
            </h5>
    </div>
        ...
        <table class='table table-bordered'>
            ...
            <tbody style="font-size: 7pt">
                ...
                <tr>
                    ...
                    ?>
                    <td colspan="2" class="text-center" style="font-weight: bold; font-size:15px">
                        {{ Rupiah($total_all) }}</td>
                </tr>
            </tbody>
        </table>
