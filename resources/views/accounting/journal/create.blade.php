                ...
                <div class="card-body">
                    <form action="{{ route('accounting.journal.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="result form-control" type="text" id="date" name="register"
                                data-dtp="dtp_abBgN" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <table class="table text-center">
                            ...
                            <tbody id="baseRow">
                                <tr class="tr">
                                    <td>
                                        <select name="accounts[]" class=" select2 accounts" required>
                                            ...
                                            @foreach ($accounts as $account)
                                                <option data-code="{{ $account->code }}" value="{{ $account->id }}">
                                    ...
                                    <td>
                                        <input type="text" min="0" name="amount[]" id="" disabled
                                            class="form-control amount" required>
                                    </td>
                                    <td>
                                        <textarea name="description_journal_detail[]" class="form-control" id="description" cols="30" rows="1"
                                            required></textarea>
                                    </td>
                                </tr>
                                <tr class="tr">
                                    ...
                                    <td>
                                        <input type="text" name="amount[]" id="" disabled
                                            class="form-control amount" required>
                                    </td>
                                    <td>
                                        <textarea name="description_journal_detail[]" class="form-control" id="" cols="30" rows="1"
                                            required></textarea>
                                    </td>
                                    <td> </td>
                                    <td> </td>
