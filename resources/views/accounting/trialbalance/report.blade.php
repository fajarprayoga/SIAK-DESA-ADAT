...
<body>
    ...
    <div style="text-align : center">
        ...
        <h5>Neraca Saldo</h5>
        <h6><a target="_blank" href="{{ url('/') }}">Periode {{ date('d F Y', strtotime($trial_balance->register)) }}
            </a></h5>
        ...
        <tbody style="font-size: 7pt">
            ...
            @foreach ($trial_balance->trial_balance_detail as $value)
                ...
                <tr>
                    ...
                    <td class="ref"> </td>
                    <td class="types">{{ $value->account->normal_balance == 'debit' ? Rupiah($value->amount) : '' }}
                    </td>
                    <td class="types">
                        {{ $value->account->normal_balance == 'credit' ? Rupiah(str_replace('-', '', $value->amount)) : '' }}
                    </td>
                </tr>
            @endforeach
            <tr>
