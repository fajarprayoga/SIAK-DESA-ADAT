...
<body>
    ...
    <div style="text-align : center">
        ...
        <h5>Laba Rugi</h5>
        <h6><a target="_blank" href="{{ url('/') }}">Periode
                {{ date('d F Y', strtotime($incomestatement->register)) }} </a></h5>
    </div>
        ...
        <tbody style="font-size: 7pt">
            ...
            <tr>
                ...
                <td class="text-center" style="font-weight: bold">
                    {{ Rupiah(str_replace('-', '', $total->amount_total)) }} </td>
                <td style="width: 3px"></td>
            </tr>
            <tr>
                <th>Pengeluaran</th>
            ...
            if ((int) (str_replace('-', '', $total->amount_total) > $total->expense_total)) {
                $text = 'LABA';
            } elseif ((int) (str_replace('-', '', $total->amount_total) < $total->expense_total)) {
                $text = 'RUGI';
            } else {
                $text = '';
            }
            ...
            <tr>
                ...
                <td></td>
                <td class="text-center" style="font-weight: bold">
                    {{ Rupiah((int) (str_replace('-', '', $total->amount_total) - $total->expense_total)) }} </td>
                <td style="width: 3px"></td>
            </tr>
        </tbody>
    </table>
